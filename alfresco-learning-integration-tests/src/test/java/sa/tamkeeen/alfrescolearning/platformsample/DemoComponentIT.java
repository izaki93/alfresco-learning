 ...
 */
package sa.tamkeeen.alfrescolearning.platformsample;
...
public class DemoComponentIT extends AbstractAlfrescoIT {
    ...
    public void testGetCompanyHome() {
        DemoComponent demoComponent = (DemoComponent) getApplicationContext().getBean("sa.tamkeeen.alfrescolearning.DemoComponent");
